...
# ---------------------------------------------------------------------------
# 4. Write apachectl wrapper
#    The ARCHIVE format ships only httpd. This wrapper sets LD_LIBRARY_PATH
#    so IHS can find its bundled libapr, passes the explicit conf path with
#    -f so httpd never falls back to its compiled-in default, and translates
#    apachectl verbs to httpd -k flags.
# ---------------------------------------------------------------------------
echo "[4/4] Writing apachectl wrapper..."
...
# ---------------------------------------------------------------------------
# 5. Add IHS bin to PATH (persisted in ~/.bashrc)
# ---------------------------------------------------------------------------
